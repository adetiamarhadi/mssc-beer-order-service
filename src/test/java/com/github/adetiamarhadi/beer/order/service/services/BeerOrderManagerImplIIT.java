...
import com.github.adetiamarhadi.brewery.model.events.AllocationFailureEvent;
...
import com.github.adetiamarhadi.beer.order.service.services.beer.BeerServiceImpl;
...
public class BeerOrderManagerImplIIT {
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        DeallocateOrderRequest deallocateOrderRequest =
                (DeallocateOrderRequest) this.jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);

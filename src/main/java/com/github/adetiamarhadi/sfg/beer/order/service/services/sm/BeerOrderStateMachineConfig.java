...
public class BeerOrderStateMachineConfig extends StateMachineConfigurerAdapter<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    public void configure(StateMachineTransitionConfigurer<BeerOrderStatusEnum, BeerOrderEventEnum> transitions)
        ...
        transitions.withExternal()
                ...
                .action(this.validateOrderAction)
                .and().withExternal()
                ...
                .action(this.validationFailureAction)
                .and().withExternal()
                ...
                .action(this.allocateOrderAction)
                .and().withExternal()
                ...
                .action(this.allocationFailureAction)
                .and().withExternal()
                ...
                .event(BeerOrderEventEnum.CANCEL_ORDER)
                .action(this.deallocateOrderAction);
    }
}

package com.github.adetiamarhadi.sfg.beer.order.service.bootstrap;
...
public class BeerOrderBootStrap implements CommandLineRunner {
    ...
    private void loadCustomerData() {
        if (this.customerRepository.findAllByCustomerNameLike(BeerOrderBootStrap.TASTING_ROOM).size() == 0) {
